...
periode_rafraichissement =  60 # En seconde
nb_valeur_graph = 600          # Nombre de valeur affichee sur les graph
...
lib_base_de_donnee.creer_graphique_capteur(1, nb_valeur_graph)
lib_base_de_donnee.creer_graphique_capteur(2, nb_valeur_graph)
